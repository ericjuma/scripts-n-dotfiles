...
[BASE] = LAYOUT_gergoplex(
    ...
    LT(SYMB, KC_ESC), MT(MOD_RSFT, KC_ENT), ALT_T(KC_BSPC),
    KC_ENT, MT(MOD_LGUI, KC_SPC), LT(NUMB, KC_TAB)
    ),
...
[NUMB] = LAYOUT_gergoplex(
    KC_5,  KC_6,  KC_7,  KC_8,     KC_9,       KC_NO,    KC_6,    KC_7,     KC_8,    KC_9,
    KC_0,  KC_1,  KC_2,  KC_3,     KC_4,       KC_LEFT,  KC_DOWN, KC_UP,    KC_RGHT, KC_VOLU,
    KC_5,  KC_6,  KC_7,  KC_8,     KC_9,       KC_MS_L,  KC_MS_D, KC_MS_U,  KC_MS_R, KC_VOLD,
                  KC_NO, KC_BTN1,  KC_BTN2,    KC_BTN2,  KC_BTN1, KC_MNXT
    )
};
