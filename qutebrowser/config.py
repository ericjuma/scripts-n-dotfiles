...
## Type: QtColor
# c.colors.completion.item.selected.match.fg = color8

## Foreground color of the matched text in the completion.
## Type: QtColor
# c.colors.completion.match.fg = color8
...
## Type: QtColor
# c.colors.downloads.start.bg = color8
...
## Type: QtColor
# c.colors.downloads.stop.bg = color0
...
## for transparency.
## Type: QssColor
# c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(200, 200, 200, 0.7), stop:1 rgba(222, 200, 200, 0.7))'
# = fg

## Font color for the matched part of hints.
## Type: QtColor
# c.colors.hints.match.fg = color9
# c.colors.hints.fg = 'rgba(255, 0, 0, 0.5)'
...
## Type: QssColor
# c.colors.statusbar.insert.bg = color6
...
## Type: QtColor
# c.colors.tabs.indicator.stop = color9
...
## Type: Dict
c.hints.selectors = {
    'all': ['a', 'area', 'textarea', 'select', 'input:not([type="hidden"])', 'button', 'frame', 'iframe',
        'img', 'link', 'summary', '[onclick]', '[onmousedown]', '[role="link"]', '[role="option"]',
        '[role="button"]', '[ng-click]', '[ngClick]', '[data-ng-click]', '[x-ng-click]', '[tabindex]'],
    'links': ['a[href]', 'area[href]', 'link[href]', '[role="link"][href]'],
    'images': ['img'],
    'media': ['audio', 'img', 'video'],
    'url': ['[src]', '[href]'],
    'inputs': ['input[type="text"]', 'input[type="date"]', 'input[type="datetime-local"]',
...
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}',
                       'rt': 'https://duckduckgo.com/?q={}+site%3A+rutracker.org',
...
## Type: List of Perc
c.zoom.levels = ['25%', '33%', '67%', '75%', '100%', '133%', '150%', '175%', '200%', '250%', '300%', '400%', '500%']
...
# config.bind("m", """spawn urxvt -e 'youtube-dl {url} -o - "~/vids/yt/%(title)s.%(height)d%(fps)d.%(ext)s" | mpv -'""")
...
#config.bind(';P', 'hint mainphoto download --dest /home/mimi/pics/.b')
